        ...
        >
          <div className="flex flex-col lg:items-start">
            ...
            <p className="mb-12 max-w-sm">
              ...
              egestas nec cursus ac, ultrices nec tellus. Nunc porta dui et
              pretium pellentesque. Aenean dignissim vulputate pharetra.
              <br />
              <br />
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus
              quis consequat dui. Mauris ut nisi felis. Cras a dictum lorem.
            </p>
            <Link
              to={"/contact"}
          ...
          <div className=" grid grid-cols-2 lg:gap-2">
            ...
            >
              <img
                className="object-cover h-full lg:h-[220] hover:scale-110 
